...
public abstract class SinkPlugin extends JavaPlugin implements BasePlugin {
  ...
  public SinkPlugin() {
    ...
    this.baseLogger = new BukkitLogger(this,
        com.github.arthurfiorette.sinklibrary.logging.Level.ALL);
  }
  ...
  @Override
  public void treatThrowable(final Object author, final Throwable exc, final String message,
      final Object... args) {
